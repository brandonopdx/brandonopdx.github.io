...
var CLIENT_ID = "06892f41f9074371855f1397caec647b";
var REDIRECT_URI = "https://brandonopdx.github.io/Connectors/spotify.html";
...
function playlistCallback(data){
	...
	tableau.connectionName = "Brandons Connector";
...
(function () {	
	...
	myConnector.getSchema = function (schemaCallback) {
		var spotify_cols = [
			...
			{ id: "playlist", alias: "Playlist Id", dataType : tableau.dataTypeEnum.string },
			//{ id: "album", alias: "album name", dataType : tableau.dataTypeEnum.string }
		...
		$.when.apply(null, async_request).done( function(){
			...
			for (i in songs){
				...
				for (j in song_names){
					...
					//var album_name = song_names[j]["album"]["name"]
					//var playlist_name = song_names[j]["name"]
					
					// add the song data to tableData
					tableData.push({ "playlist" : playlist_id, "song" : song_title, "date_added": date_added, "artist" : artist})
				}
			}
